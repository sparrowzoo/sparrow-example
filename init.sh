rm -rf admin/example-admin-adapter/src
rm -rf admin/example-admin-dao-api/src
rm -rf admin/example-admin-dao-sparrow/src
rm -rf admin/example-admin-domain/src
rm -rf admin/example-admin-infrastructure/src
rm -rf admin/example-admin-protocol/src
